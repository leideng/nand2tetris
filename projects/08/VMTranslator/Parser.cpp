...
std::string Parser::convertToAsm() const
{
    ...
    switch(type)
    {
        ...
        case C_LABEL:
            return convertToAsmLabel();
        case C_GOTO:
            return convertToAsmGoto();
        case C_IF:
            return convertToAsmIf();
        case C_FUNCTION:
            return convertToAsmFunction();
        case C_RETURN:
            return convertToAsmReturn();
        case C_CALL:
            return convertToAsmCall();
        default:
...
std::string Parser::convertToAsmLabel() const
{
    std::string asm_code;
...
std::string Parser::convertToAsmGoto() const
{
    std::string asm_code;
...
std::string Parser::convertToAsmIf() const
{
    std::string asm_code;
...
std::string Parser::convertToAsmReturn() const
{
    std::string asm_code;
